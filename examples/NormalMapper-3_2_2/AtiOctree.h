...
//==============================================================================
// $File: //depot/3darg/Demos/Sushi/Math/AtiOctree.h $ $Revision: 1.1 $ $Author: hax22 $
//==============================================================================
...
class AtiOctreeCell
{
   public:
      ...
      // Con/de-struction
      AtiOctreeCell (void);
      AtiOctreeCell (IGenericStream* stream);
      ~AtiOctreeCell (void);

      void Serialize(IGenericStream* stream);
      
      DWORD ApproximateSize();
...
class AtiOctree
{
   public:
      ...
      // Con/de-struction
      AtiOctree (void);
      AtiOctree (IGenericStream* stream);
      ~AtiOctree (void);
      
      void Serialize(IGenericStream* stream);
      
      DWORD ApproximateSize() const;
