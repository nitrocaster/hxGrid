...
//=============================================================================
// $File: //depot/3darg/Demos/Sushi/Math/AtiOctree.cpp $ $Revision: 1.1 $ $Author: hax22 $
//=============================================================================
...
//=====================================================================
//=====================================================================
AtiOctreeCell::AtiOctreeCell (IGenericStream* stream)
{
 stream->Read(&m_boundingBox, sizeof(AtiOctBoundingBox));

 for (DWORD i=0; i<8; i++)
  {
   stream->Read(&m_children[i], 4);
  }

 stream->Read(&m_numItems, sizeof(int32));
 
 if (m_numItems>0)
  {
   m_item = new int32[m_numItems];
   stream->Read(m_item, m_numItems*sizeof(int32));
  }
   else
  {
   m_item = NULL;
 ...
 for (DWORD i=0; i<8; i++)
  {
   if (m_children[i]!=NULL)
    {
     m_children[i] = new AtiOctreeCell(stream);
    }
  }
}
...
//=====================================================================
//=====================================================================
void AtiOctreeCell::Serialize(IGenericStream* stream)
{
 stream->Write(&m_boundingBox, sizeof(AtiOctBoundingBox));
 
 for (DWORD i=0; i<8; i++)
  {
   stream->Write(&m_children[i], 4);
  }
 
 stream->Write(&m_numItems, sizeof(int32));
 stream->Write(m_item, m_numItems*sizeof(int32));
 
 for (DWORD i=0; i<8; i++)
  {
   if (m_children[i]!=NULL)
    {
     m_children[i]->Serialize(stream);
    }
  }
}
...
//=====================================================================
//=====================================================================
DWORD AtiOctreeCell::ApproximateSize()
{
 DWORD d = sizeof(AtiOctBoundingBox);
 d += 8*4;
 d += sizeof(int32);
 d += m_numItems*sizeof(int32);
 
 for (DWORD i=0; i<8; i++)
  {
   if (m_children[i]!=NULL)
    {
     d += m_children[i]->ApproximateSize();
    }
  }
 return d;
}
...
//====================================================================
//====================================================================
AtiOctree::AtiOctree(IGenericStream* stream)
{
 m_root = new AtiOctreeCell(stream);
}
 
//====================================================================
//====================================================================
void AtiOctree::Serialize(IGenericStream* stream)
{
...
//====================================================================
//====================================================================
DWORD AtiOctree::ApproximateSize() const
{
 return m_root->ApproximateSize();
}
